...
const DEPRECATED_TAGS_REGEX =
	/<(center|font|marquee|blink|strike|big|tt|frameset|frame|noframes)\b/gi;
...
const TARGET_BLANK_TEST =
	/target\s*=\s*["']_blank["'](?![^>]*\brel\s*=\s*["'](?:[^"']*\s)?noopener(?:[^"']*)?["'])/i;
...
const analyzeNesting = (
	...
	const cleanedSource = sourceCode.replaceAll(
...
// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
const analyzeDocumentStructure = (
	sourceCode: string,
): Pick<
	HtmlAnalysisResult,
	`hasDoctype` | `hasHtmlLang` | `hasMetaCharset` | `hasMetaViewport`
> => {
	...
	const hasMetaViewport = /<meta[^/>]*name\s*=\s*["']viewport["']/i.test(
		sourceCode,
	);
...
export const generateHtmlAnalysisDiagnostics = (
