...
export class JSHintCodeActionProvider implements vscode.CodeActionProvider {
	...
	provideCodeActions(
		...
		const jsHinthintDiagnostics = context.diagnostics.filter(
		...
		jsHinthintDiagnostics.length > 0 &&
			(() => {
				const sourceActions = this.createSourceActions(
					document,
					jsHinthintDiagnostics,
				);
	...
	// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
	private createAdvancedQuickFixes(
		document: vscode.TextDocument,
		...
		!code
			...
			: code === `W033`
				...
				: code === `W116`
					...
					: code === `W117`
						? actions.push(
								...this.createUndefinedVariableFixes(document, diagnostic),
							)
						: code === `W098`
							? actions.push(
									...this.createUnusedVariableFixes(document, diagnostic),
								)
							: code === `prefer-let-const`
								? actions.push(
										...this.createVarToLetConstFixes(document, diagnostic),
									)
								: code === `missing-strict-mode`
									? actions.push(
											...this.createStrictModeFixes(document, diagnostic),
										)
									: (code.startsWith(`complexity-`) ?? code.startsWith(`bug-`))
										? actions.push(
												...this.createAnalysisFixes(document, diagnostic, code),
											)
										: (() => {
												const genericFix = this.createGenericFix(
													document,
													diagnostic,
													code,
												);
	...
	// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
	private createUndefinedVariableFixes(
		document: vscode.TextDocument,
		diagnostic: Diagnostic,
	): CodeAction[] {
		const actions: CodeAction[] = [];
		...
		edit.insert(
			document.uri,
			insertPos,
			`// TODO: define or import variable\n`,
		);
	...
	// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
	private createUnusedVariableFixes(
		document: vscode.TextDocument,
		diagnostic: Diagnostic,
	): CodeAction[] {
		const actions: CodeAction[] = [];
		const removeVar = new CodeAction(
	...
	// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
	private createVarToLetConstFixes(
		document: vscode.TextDocument,
		diagnostic: Diagnostic,
	): CodeAction[] {
		const actions: CodeAction[] = [];
	...
	// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
	private createStrictModeFixes(
		document: vscode.TextDocument,
		diagnostic: Diagnostic,
	): CodeAction[] {
		const actions: CodeAction[] = [];
		const addStrict = new CodeAction(
			`Add 'use strict' at file start`,
			CodeActionKind.QuickFix,
		);
		const edit = new vscode.WorkspaceEdit();
			...
			: code === `bug-assignment-in-condition`
				? (() => {
						const fixAssignment = new CodeAction(
							`Change assignment to comparison operator`,
							CodeActionKind.QuickFix,
						);
				...
				: (() => {
						...
						edit.insert(
							document.uri,
							insertPos,
							`// FIXME: resolve ${code.replace(`bug-`, ``).replace(`-`, ` `)} issue\n`,
						);
						bugFix.edit = edit;
	...
	private createSourceActions(
		...
		const organizeImports = new CodeAction(
			`Attempt to fix all JSHint issues`,
